...
* **Associated ACAI Concepts:** David (ID: `person:David`); City of David (ID: `place:CityOfDavid`)
## Débora (id: 668880)
...
* **Associated ACAI Concepts:** Débora (ID: `person:Deborah.2`); Barak (ID: `person:Barak`)
