...
* **Associated ACAI Concepts:** Lea (ID: `person:Leah`); Esaú (ID: `person:Esau`)
...
* **Associated ACAI Concepts:** los (ID: `place:Athach`); Amalec (ID: `place:Amalek`); Amalekites (ID: `group:Amalek`)
...
* **Associated ACAI Concepts:** los (ID: `group:Philistine`); Filisteos (ID: `place:Philistine`); los (ID: `person:Philistine`); los (ID: `place:Shephelah`)
