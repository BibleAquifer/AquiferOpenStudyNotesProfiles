...
* **Associated ACAI Concepts:** Raheli (ID: `person:Rachel`); Ashbeli (ID: `person:Ashbel`)
## Rebeka (id: 734302)
...
* **Associated ACAI Concepts:** Rebeka (ID: `person:Rebekah`); A Half Shekel (ID: `realia:AHalfShekel`)
## Rehoboamu (id: 734342)
...
* **Associated ACAI Concepts:** Rehoboamu (ID: `person:Rehoboam`); Yeroboamu (ID: `person:Jeroboam`)
## Rumi (id: 734408)
